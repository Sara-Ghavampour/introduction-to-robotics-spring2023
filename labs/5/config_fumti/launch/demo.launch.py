...
def generate_launch_description():
    moveit_config = MoveItConfigsBuilder("model", package_name="config_fumti").to_moveit_configs()
...
# 1-first launch gz_sim 
# 2- second run another node 
    ...
    #         arguments=[
    #             # {"world": "empty.sdf"},
    #             "-file", "src/robot_fumti/urdf/FUMTI.urdf.xacro"
    #         ],
    #     )
    # )
